...
export const USERS = [
  new User(
    "Louis Litt",
    STATUSES.BUSY,
    "https://images.pexels.com/photos/30659550/pexels-photo-30659550/free-photo-of-charming-yellow-wall-with-rustic-window.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    generateMessage(10)
  ),
  new User(
    "Harvey Specter",
    STATUSES.ONLINE,
    "https://images.pexels.com/photos/30767572/pexels-photo-30767572/free-photo-of-professional-portrait-of-a-smiling-man.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
    generateMessage(7)
  ),
  new User(
    "Aman Yadav",
